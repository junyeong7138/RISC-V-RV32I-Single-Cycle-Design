module SMU_RV32I_System (
  ...
  wire [31:0] be_Read_Data, be_Write_Data;

  // ======================= TBMAN ==================================
    // Address Decoder / Data Mux / TBMAN
  wire        cs_dmem_n;
  wire        cs_tbman_n;
  ...
  // );
    ...
    ASYNC_RAM_DP_WBE #(
      ...
      .q0       (Instr),
      .q1       (read_data_dmem)  // ReadData -> read_data_dmem
    );
  ...
  Addr_Decoder u_addr_decoder (
    ...
    tbman_wrap u_tbman (
      ...
      // Native Port
      .tbman_sel  (~cs_tbman_n),        // CS_TBMAN_N은 Active Low니까 반전
      .tbman_write(MemWrite),           // Write=1, Read=0
      .tbman_addr (DataAdr[15:0]),      // 하위 16비트 사용
